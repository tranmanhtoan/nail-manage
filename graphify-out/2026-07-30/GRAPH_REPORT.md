...
## Summary
- 332 nodes · 454 edges · 26 communities (21 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31028298`
...
Cohesion: 0.15
Nodes (10): AdminDashboard(), AdminStats, CATEGORIES, Services(), DEFAULT_TOGGLES, FeatureToggles, Settings(), Tab (+2 more)
...
## Knowledge Gaps
- **168 isolated node(s):** `Thêm mới`, `Chỉnh sửa`, `Tích hợp`, `Chỉnh sửa`, `Dashboard` (+163 more)
