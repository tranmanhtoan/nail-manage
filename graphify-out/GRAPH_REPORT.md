...
## Corpus Check
- 57 files · ~33,274 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 279 nodes · 429 edges · 17 communities (15 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72fd644f`
...
- `Settings()` --calls--> `useThemeStore`  [EXTRACTED]
  src/pages/owner/Settings.tsx → src/store/themeStore.ts
...
Cohesion: 0.13
Nodes (11): LanguageSwitch(), Service, Login(), OwnerProfile, CATEGORIES, Services(), DEFAULT_TOGGLES, FeatureToggles (+3 more)

### Community 2 - "supabase.ts"
Cohesion: 0.09
Nodes (15): PinGateProps, toAuthEmail(), Appointment, Customer, Employee, PayType, supabase, supabaseAdmin (+7 more)
...
Cohesion: 0.11
Nodes (25): BottomNav(), EmployeeLayout(), FloatingBackHome(), Header(), OfflineSyncBanner(), useInactivityTimeout(), UserRole, CheckIn() (+17 more)
...
Cohesion: 0.08
Nodes (14): Admin, Appointments, BookingPage, Customers, Dashboard, EmployeeLayout, KioskLayout, PinGate (+6 more)
...
Cohesion: 0.16
Nodes (8): AdminDashboard(), AdminStats, AdminServices(), CATEGORIES, AdminSettings(), DEFAULT_TOGGLES, FeatureToggles, Tab
...
## Knowledge Gaps
- **129 isolated node(s):** `Thêm mới`, `Chỉnh sửa`, `SyncState`, `name`, `private` (+124 more)
...
- **Why does `supabase` connect `supabase.ts` to `Settings.tsx`, `Appointments.tsx`, `Dashboard.tsx`, `useAuthStore`, `AdminSettings.tsx`, `Reports.tsx`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `useAuthStore` to `Settings.tsx`, `supabase.ts`, `Dashboard.tsx`, `App.tsx`, `AdminSettings.tsx`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **What connects `Thêm mới`, `Chỉnh sửa`, `SyncState` to the rest of the system?**
