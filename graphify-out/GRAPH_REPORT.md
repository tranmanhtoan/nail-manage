...
## Corpus Check
- 65 files · ~44,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 333 nodes · 453 edges · 25 communities (20 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d64f29d`
...
Cohesion: 0.20
Nodes (9): OfflineSyncBanner(), Employee, QuickEntry(), Service, Step, FailedAction, SyncAction, SyncState (+1 more)

### Community 1 - "Appointments.tsx"
Cohesion: 0.07
Nodes (19): Appointment, AppointmentStatus, Customer, Employee, UserRole, supabaseAdmin, AppointmentRow, Appointments() (+11 more)
...
Cohesion: 0.14
Nodes (9): LanguageSwitch(), Service, AdminDashboard(), AdminStats, CATEGORIES, Services(), DEFAULT_TOGGLES, FeatureToggles (+1 more)
...
Cohesion: 0.08
Nodes (30): BottomNav(), FloatingBackHome(), PinGateProps, useInactivityTimeout(), toAuthEmail(), PayType, initAuthListener(), stopAuthListener() (+22 more)
...
## Knowledge Gaps
- **167 isolated node(s):** `Chỉnh sửa`, `AuthState`, `supabaseUrl`, `supabaseAnonKey`, `Dashboard` (+162 more)
...
- **Why does `supabase` connect `supabase.ts` to `QuickEntry.tsx`, `Appointments.tsx`, `Reports.tsx`, `Settings.tsx`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `supabase.ts` to `QuickEntry.tsx`, `App.tsx`, `Settings.tsx`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `Chỉnh sửa`, `AuthState`, `supabaseUrl` to the rest of the system?**
