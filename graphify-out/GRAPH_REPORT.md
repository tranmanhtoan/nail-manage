...
## Knowledge Gaps
- **167 isolated node(s):** `Chỉnh sửa`, `supabaseUrl`, `supabaseAnonKey`, `Dashboard`, `Appointments` (+162 more)
...
- **Why does `supabase` connect `useAuthStore` to `QuickEntry.tsx`, `Appointments.tsx`, `supabase.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `useAuthStore` to `QuickEntry.tsx`, `App.tsx`, `supabase.ts`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `Chỉnh sửa`, `supabaseUrl`, `supabaseAnonKey` to the rest of the system?**
