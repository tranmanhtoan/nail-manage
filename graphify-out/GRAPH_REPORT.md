...
## Corpus Check
- 65 files · ~45,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 338 nodes · 455 edges · 25 communities (20 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8923b219`
...
Cohesion: 0.13
Nodes (11): LanguageSwitch(), Login(), OwnerProfile, AdminDashboard(), AdminStats, Employees(), DEFAULT_TOGGLES, FeatureToggles (+3 more)
...
Cohesion: 0.11
Nodes (12): PinGateProps, toAuthEmail(), initAuthListener(), stopAuthListener(), supabaseAdmin, supabaseAnonKey, supabaseUrl, DAYS (+4 more)
...
Cohesion: 0.09
Nodes (26): BottomNav(), FloatingBackHome(), Header(), OfflineSyncBanner(), useInactivityTimeout(), PayType, supabase, CheckIn() (+18 more)
...
- **Why does `supabase` connect `supabase` to `Settings.tsx`, `Appointments.tsx`, `Reports.tsx`, `supabase.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useAuthStore` connect `supabase` to `Settings.tsx`, `App.tsx`, `supabase.ts`?**
